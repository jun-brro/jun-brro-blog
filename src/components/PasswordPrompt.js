...
const PasswordPrompt = ({ onConfirm, onCancel }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="relative bg-white dark:bg-black text-dark dark:text-light p-6 sm:p-10 md:p-12 rounded-lg shadow-lg transform transition-transform duration-300 animate-fadeIn sm:w-3/4 md:w-1/2">
        ...
        <div className="flex justify-end mt-4">
          ...
          <button
            ...
            className="py-2 px-4 bg-accent dark:bg-accentDark text-white dark:text-black rounded hover:bg-accenthover dark:hover:bg-accentDark-hover transition"
          >
            Confirm
          </button>
        </div>
